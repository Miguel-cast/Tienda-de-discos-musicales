    ...
    public class ProveedoresModel : PageModel
    {
        ...
        public void OnPostBtRefrescar()
        {
            try
            {
                ...
                //    return;
                //}
                Filtro!.NombreEmpresa = Filtro!.NombreEmpresa ?? "";
                Accion = Enumerables.Ventanas.Listas;
                var task = this.iPresentacion!.PorNombreEmpresa(Filtro!);
                task.Wait();
                Lista = task.Result;
                Actual = null;
            }
        ...
        public virtual void OnPostBtModificar(string data)
        {
            try
            {
                OnPostBtRefrescar();
                Accion = Enumerables.Ventanas.Editar;
                Actual = Lista!.FirstOrDefault(x => x.ProveedoresId.ToString() == data);
            }
            catch (Exception ex)
            {
                LogConversor.Log(ex, ViewData!);
