...
namespace asp_servicios.Controllers
{
    ...
    public class ProveedoresController : ControllerBase
    {
        ...
        public ProveedoresController(IProveedoresAplicacion? iAplicacion, TokenAplicacion tokenAplicacion)
        {
        ...
        [HttpPost]
        public string PorNombreEmpresa()
        {
            var respuesta = new Dictionary<string, object>();
            try
            {
                ...
                respuesta["Entidades"] = this.iAplicacion!.PorNombreEmpresa(entidad);
                respuesta["Respuesta"] = "OK";
                respuesta["Fecha"] = DateTime.Now.ToString();
